        ...
        <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
            <div>
                ...
                <nav className="nav hidden lg:block">
                    <ul className="mt-16 w-max list-none">
                        <li>
                            <a
                                className={`group flex items-center py-3 ${activeSection === 'about' ? 'hover-effect' : ''
                                    }`}
                                href="#about"
                            >
                                <span
                        ...
                        <li>
                            <a
                                className={`group flex items-center py-3 ${activeSection === 'experience' ? 'hover-effect' : ''
                                    }`}
                                href="#experience"
                            >
                                <span
                        ...
                        <li>
                            <a
                                className={`group flex items-center py-3 ${activeSection === 'projects' ? 'hover-effect' : ''
                                    }`}
                                href="#projects"
                            >
                                <span
            ...
            <ul className="ml-1 mt-8 flex items-center">
                <li className="mr-5 text-xs shrink-0">
                    <a class="block hover:text-slate-200" href="https://github.com/brianqch" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub"><span class="sr-only">GitHub</span>
                ...
                <li>
                <a class="block hover:text-slate-200" href="https://www.linkedin.com/in/briandquach/" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn"><span class="sr-only">LinkedIn</span>
