    ...
    return (
        <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
            <div>
                ...
                <p className="mt-4 max-w-xs leading-normal text-slate-200">Building with passion and purpose.</p>
            ...
            <ul className="ml-1 mt-8 flex items-center">
                <li className="mr-5 text-xs shrink-0">
                    <a className="block hover:text-slate-200 text-white" href="https://github.com/brianqch" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub"><span className="sr-only">GitHub</span>
                ...
                <li>
                    <a className="block hover:text-slate-200 text-white" href="https://www.linkedin.com/in/briandquach/" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn"><span className="sr-only">LinkedIn</span>
