                    ...
                    <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <Image
                                ...
                                alt="Screenshot of Cookbook.AI project image"
                                loading="lazy"
                                width={200}
                                height={48}
                    ...
                    <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <Image
                                ...
                                alt="Screnshot of Seedling Project"
                                loading="lazy"
                                width={200}
                                height={48}
                                className="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                    ...
                    <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <Image
                                ...
                                alt="Screenshot of Cloth Simulator project"
                                loading="lazy"
                                width={200}
                                height={48}
                                className="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                    ...
                    <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <Image
                                ...
                                src="/codecomment_image.png"
                                alt="Screenshot of Code Comment Project"
                                loading="lazy"
                                width={200}
                                height={48}
                                className="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                            ...
                            <div className="z-10 sm:order-2 sm:col-span-6">
                                <h3 className="font-medium leading-snug text-slate-200">
                                    <div>
                                        <span className="inline-flex flex-col items-baseline font-medium leading-tight  hover:text-[#518ee0] focus-visible:text-[#518ee0] group/link text-base">
                                            <span className="text-slate-200">AI Code Comment Generator</span>
                                        </span>
                                        {/* <span class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span> */}
                                    </div>
                                </h3>
                                <p className="mt-2 text-sm leading-normal text-slate-200">
                                    • Developed an AI-driven code comment generator using Next.js, TypeScript, and Cohere's GenAI, automating the process of creating context-aware code comments to improve code readability and maintainability.
                                </p>
                                <ul className="mt-2 flex flex-wrap">
                                <li className="mr-1.5 mt-2"><div className="flex items-center rounded-full bg-[#518ee0] px-3 py-1 text-xs font-medium leading-5 text-white">Next.js</div></li>
                                    <li className="mr-1.5 mt-2"><div className="flex items-center rounded-full bg-[#518ee0] px-3 py-1 text-xs font-medium leading-5 text-white">TypeScript</div></li>
                                </ul>
                            </div>
                        </div>
                    </li>
